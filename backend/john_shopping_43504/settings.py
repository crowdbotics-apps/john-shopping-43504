"""
Django settings for john_shopping_43504 project.
...
ROOT_URLCONF = 'john_shopping_43504.urls'
...
WSGI_APPLICATION = 'john_shopping_43504.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "john_shopping_43504 API",
    "DESCRIPTION": "API documentation for john_shopping_43504 App",
    "VERSION": "v1",
}
